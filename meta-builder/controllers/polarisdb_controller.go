...
// +kubebuilder:rbac:groups=synopsys.com,resources=polarisdbs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=synopsys.com,resources=polarisdbs/status,verbs=get;update;patch

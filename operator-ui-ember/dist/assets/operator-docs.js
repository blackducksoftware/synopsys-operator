...
;
          if (!runningTests) {
            require("operator-docs/app")["default"].create({"name":"operator-docs","version":"0.0.0+6776e135"});
          }

...
func (hc *Creater) createDeployer(deployer *horizon.Deployer, createHub *v1.Hub, hubContainerFlavor *ContainerFlavor, allConfigEnv []*horizonapi.EnvConfig) {
	...
	cfssl := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "cfssl", Replicas: util.IntToInt32(1)},
	...
	webserver := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "webserver", Replicas: util.IntToInt32(1)},
	...
	documentation := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "documentation", Replicas: util.IntToInt32(1)},
	...
	solr := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "solr", Replicas: util.IntToInt32(1)},
	...
	registration := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "registration", Replicas: util.IntToInt32(1)},
	...
	zookeeper := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "zookeeper", Replicas: util.IntToInt32(1)},
	...
	jobRunner := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "jobrunner", Replicas: hubContainerFlavor.JobRunnerReplicas},
	...
	hubScan := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "hub-scan", Replicas: hubContainerFlavor.ScanReplicas},
	...
	hubAuth := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "hub-authentication", Replicas: util.IntToInt32(1)},
	...
	webappLogstash := util.CreateDeploymentFromContainer(&horizonapi.DeploymentConfig{Namespace: createHub.Spec.Namespace, Name: "webapp-logstash", Replicas: util.IntToInt32(1)}, []*util.Container{webappContainerConfig, logstashContainerConfig},
	...
	deployer.AddService(util.CreateService("cfssl", "cfssl", createHub.Spec.Namespace, cfsslPort, cfsslPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("zookeeper", "zookeeper", createHub.Spec.Namespace, zookeeperPort, zookeeperPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("webserver", "webserver", createHub.Spec.Namespace, "443", webserverPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("webserver-np", "webserver", createHub.Spec.Namespace, "443", webserverPort, horizonapi.ClusterIPServiceTypeNodePort))
	deployer.AddService(util.CreateService("webserver-lb", "webserver", createHub.Spec.Namespace, "443", webserverPort, horizonapi.ClusterIPServiceTypeLoadBalancer))
	deployer.AddService(util.CreateService("webapp", "webapp-logstash", createHub.Spec.Namespace, webappPort, webappPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("logstash", "webapp-logstash", createHub.Spec.Namespace, logstashPort, logstashPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("solr", "solr", createHub.Spec.Namespace, solrPort, solrPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("documentation", "documentation", createHub.Spec.Namespace, documentationPort, documentationPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("scan", "hub-scan", createHub.Spec.Namespace, scannerPort, scannerPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("authentication", "hub-authentication", createHub.Spec.Namespace, authenticationPort, authenticationPort, horizonapi.ClusterIPServiceTypeDefault))
	deployer.AddService(util.CreateService("registration", "registration", createHub.Spec.Namespace, registrationPort, registrationPort, horizonapi.ClusterIPServiceTypeDefault))
}

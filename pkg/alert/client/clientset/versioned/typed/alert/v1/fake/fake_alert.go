...
var alertsResource = schema.GroupVersionResource{Group: "synopsys", Version: "v1", Resource: "alerts"}
...
func (c *FakeAlerts) List(opts v1.ListOptions) (result *alert_v1.AlertList, err error) {
	...
	list := &alert_v1.AlertList{ListMeta: obj.(*alert_v1.AlertList).ListMeta}

	...
	var tests = []struct {
		...
		// case
		{
			...
			changedSpec: &blackduckapi.BlackduckSpec{PVC: []blackduckapi.PVC{
				{Name: "blackduck-postgres", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-postgres-pv"},
				{Name: "blackduck-cfssl", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-cfssl-pv"},
				{Name: "blackduck-registration", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-registration-pv"},
				{Name: "blackduck-zookeeper", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-zookeeper-pv"},
				{Name: "blackduck-authentication", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-authentication-pv"},
				{Name: "blackduck-webapp", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-webapp-pv"},
				{Name: "blackduck-logstash", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-logstash-pv"},
				{Name: "blackduck-uploadcache-data", Size: "1Gi", StorageClass: "default", VolumeName: "blackduck-uploadcache-data-pv"},
			}},
		},
		// case
		{

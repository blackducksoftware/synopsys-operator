...
func InitDatabase(createHub *v1.BlackduckSpec, adminPassword string, userPassword string, postgresPassword string) error {
	...
	// postgres database
	err := apps.ExecDBStatements(hostName, "postgres", "postgres", postgresPassword, "postgres", []string{
	...
	// bds_hub database
	err = apps.ExecDBStatements(hostName, "bds_hub", "postgres", postgresPassword, "postgres", []string{
	...
	err = apps.ExecDBStatements(hostName, "bds_hub_report", "postgres", postgresPassword, "postgres", []string{
	...
	// bdio database
	err = apps.ExecDBStatements(hostName, "bdio", "postgres", postgresPassword, "postgres", []string{

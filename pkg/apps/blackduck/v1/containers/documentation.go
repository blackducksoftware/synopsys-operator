...
func (c *Creater) GetDocumentationDeployment(imageName string) (*components.ReplicationController, error) {
	...
	return util.CreateReplicationControllerFromContainer(&horizonapi.ReplicationControllerConfig{Namespace: c.hubSpec.Namespace, Name: "documentation", Replicas: util.IntToInt32(1)}, "",
		[]*util.Container{documentationContainerConfig}, []*components.Volume{documentationEmptyDir}, []*util.Container{}, []horizonapi.PodAffinityConfig{}, c.GetVersionLabel("documentation"), c.GetLabel("documentation"), c.hubSpec.RegistryConfiguration.PullSecrets)
}

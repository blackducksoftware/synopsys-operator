...
func (c *Creater) GetDocumentationDeployment(imageName string) (*components.ReplicationController, error) {
	...
	return util.CreateReplicationControllerFromContainer(
		&horizonapi.ReplicationControllerConfig{Namespace: c.hubSpec.Namespace, Name: util.GetResourceName(c.name, "documentation", c.isClusterScope), Replicas: util.IntToInt32(1)},
		&util.PodConfig{
...
func (c *Creater) GetDocumentationService() *components.Service {
	return util.CreateService(util.GetResourceName(c.name, "documentation", c.isClusterScope), c.GetLabel("documentation"), c.hubSpec.Namespace, documentationPort, documentationPort, horizonapi.ServiceTypeServiceIP, c.GetVersionLabel("documentation"))
}

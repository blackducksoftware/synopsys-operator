...
func (b BdService) GetService() *components.Service {
	return util.CreateService(util.GetResourceName(b.blackduck.Name, util.BlackDuckName, "solr"), utils.GetLabel("solr", b.blackduck.Name), b.blackduck.Spec.Namespace, int32(8983), int32(8983), horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("solr", b.blackduck.Name, b.blackduck.Spec.Version))
}

...
func (b BdService) GetService() *components.Service {
	return util.CreateService(apputils.GetResourceName(b.blackDuck.Name, util.BlackDuckName, "cfssl"), apputils.GetLabel("cfssl", b.blackDuck.Name), b.blackDuck.Spec.Namespace, int32(8888), int32(8888), horizonapi.ServiceTypeServiceIP, apputils.GetVersionLabel("cfssl", b.blackDuck.Name, b.blackDuck.Spec.Version))
}
...
func init() {
	store.Register(blackduck.BlackDuckCfsslServiceV1, NewBdService)
}

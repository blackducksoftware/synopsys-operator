...
func (b BdService) GetService() *components.Service {
	return util.CreateService(util.GetResourceName(b.blackduck.Name, util.BlackDuckName, "cfssl"), utils.GetLabel("cfssl", b.blackduck.Name), b.blackduck.Spec.Namespace, int32(8888), int32(8888), horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("cfssl", b.blackduck.Name, b.blackduck.Spec.Version))
}

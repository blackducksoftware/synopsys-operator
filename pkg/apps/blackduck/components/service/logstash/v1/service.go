...
func (b BdService) GetService() *components.Service {
	return util.CreateService(util.GetResourceName(b.blackduck.Name, util.BlackDuckName, "logstash"), utils.GetLabel("webapp-logstash", b.blackduck.Name), b.blackduck.Spec.Namespace, int32(5044), int32(5044), horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("webapp-logstash", b.blackduck.Name, b.blackduck.Spec.Version))
}

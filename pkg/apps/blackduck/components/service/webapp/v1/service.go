...
func (b BdService) GetService() *components.Service {
	return util.CreateService("webapp", utils.GetLabel("webapp-logstash", b.blackduck.Name), b.blackduck.Spec.Namespace, int32(8443), int32(8443), horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("webapp-logstash", b.blackduck.Name, b.blackduck.Spec.Version))
}
...
func init() {
	store.Register(types.ServiceWebappV1, NewBdService)
}

...
func (b BdService) GetService() *components.Service {
	return util.CreateService(util.GetResourceName(b.blackduck.Name, util.BlackDuckName, "scan"), utils.GetLabel("scan", b.blackduck.Name), b.blackduck.Spec.Namespace, int32(8443), int32(8443), horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("scan", b.blackduck.Name, b.blackduck.Spec.Version))
}

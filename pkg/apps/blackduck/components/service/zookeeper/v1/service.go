...
func (b BdService) GetService() *components.Service {
	return util.CreateService(util.GetResourceName(b.blackduck.Name, util.BlackDuckName, "zookeeper"), utils.GetLabel("zookeeper", b.blackduck.Name), b.blackduck.Spec.Namespace, int32(2181), int32(2181), horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("zookeeper", b.blackduck.Name, b.blackduck.Spec.Version))
}

...
func (b BdService) GetService() *components.Service {
	return util.CreateServiceWithMultiplePort("uploadcache", utils.GetLabel("uploadcache", b.blackduck.Name), b.blackduck.Spec.Namespace, []int32{int32(9443), int32(9444)},
		horizonapi.ServiceTypeServiceIP, utils.GetVersionLabel("uploadcache", b.blackduck.Name, b.blackduck.Spec.Version))
}

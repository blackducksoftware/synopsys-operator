...
#
docker pull gcr.io/snps-swip-staging/reporting-frontend-service:0.0.713
docker pull gcr.io/snps-swip-staging/reporting-polaris-service:0.0.148
docker pull gcr.io/snps-swip-staging/reporting-report-service:0.0.481
docker pull gcr.io/snps-swip-staging/reporting-rp-issue-manager:0.0.536
docker pull gcr.io/snps-swip-staging/reporting-rp-portfolio-service:0.0.743
docker pull gcr.io/snps-swip-staging/reporting-tools-portfolio-service:0.0.1027
docker pull gcr.io/snps-swip-staging/reporting-clamav:latest
#

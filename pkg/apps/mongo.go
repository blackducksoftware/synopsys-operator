...
func (p *Mongo) GetMongoReplicationController() (*components.ReplicationController, error) {
	...
	return util.CreateReplicationControllerFromContainer(
		&horizonapi.ReplicationControllerConfig{Namespace: p.Namespace, Name: mongoName, Replicas: util.IntToInt32(1)},
		&util.PodConfig{
			Volumes:        mongoVolumes,
			Containers:     []*util.Container{mongoExternalContainerConfig},

...
func init() {
	store.Register(types.OpsSightImageProcessorClusterRoleBindingV1, NewOpsSightClusterRoleBinding)
}
...
func (o *OpsSightClusterRoleBinding) GetClusterRoleBinding() (*components.ClusterRoleBinding, error) {
	...
	clusterRoleBinding.AddLabels(map[string]string{"component": o.opsSight.Spec.Perceiver.ImagePerceiver.Name, "app": "opssight", "name": o.opsSight.Name})

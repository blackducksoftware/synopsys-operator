...
func init() {
	store.Register(types.OpsSightScannerServiceAccountV1, NewOpsSightServiceAccount)
}
...
func (o *OpsSightServiceAccount) GetServiceAccount() (*components.ServiceAccount, error) {
	...
	serviceAccount.AddLabels(map[string]string{"component": o.opsSight.Spec.ScannerPod.ImageFacade.ServiceAccount, "app": "opssight", "name": o.opsSight.Name})

...
func init() {
	store.Register(types.OpsSightPodProcessorClusterRoleV1, NewOpsSightClusterRole)
}
...
func (o *OpsSightClusterRole) GetClusterRole() (*components.ClusterRole, error) {
	...
	clusterRole.AddLabels(map[string]string{"component": o.opsSight.Spec.Perceiver.PodPerceiver.Name, "app": "opssight", "name": o.opsSight.Name})

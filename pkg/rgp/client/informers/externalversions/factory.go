...
import (
	...
	rgp "github.com/blackducksoftware/synopsys-operator/pkg/rgp/client/informers/externalversions/rgp"
...
type SharedInformerFactory interface {
	...
	Synopsys() rgp.Interface
}

func (f *sharedInformerFactory) Synopsys() rgp.Interface {
	return rgp.New(f, f.namespace, f.tweakListOptions)
}

...
func (ctl *BlackduckCtl) AddSpecFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&ctl.ExternalPostgresPostgresHost, "spec-external-postgres-host", ctl.ExternalPostgresPostgresHost, "Host for Postgres")
	cmd.Flags().IntVar(&ctl.ExternalPostgresPostgresPort, "spec-external-postgres-port", ctl.ExternalPostgresPostgresPort, "Port for Postgres")
	cmd.Flags().StringVar(&ctl.ExternalPostgresPostgresAdmin, "spec-external-postgres-admin", ctl.ExternalPostgresPostgresAdmin, "Name of Admin for Postgres")
	cmd.Flags().StringVar(&ctl.ExternalPostgresPostgresUser, "spec-external-postgres-user", ctl.ExternalPostgresPostgresUser, "Username for Postgres")
	cmd.Flags().BoolVar(&ctl.ExternalPostgresPostgresSsl, "spec-external-postgres-ssl", ctl.ExternalPostgresPostgresSsl, "TODO")
	cmd.Flags().StringVar(&ctl.ExternalPostgresPostgresAdminPassword, "spec-external-postgres-admin-password", ctl.ExternalPostgresPostgresAdminPassword, "Password for the Postgres Admin")
	cmd.Flags().StringVar(&ctl.ExternalPostgresPostgresUserPassword, "spec-external-postgres-user-password", ctl.ExternalPostgresPostgresUserPassword, "Password for a Postgres User")
	...
	cmd.Flags().StringSliceVar(&ctl.PVCJSONSlice, "spec-pvc", ctl.PVCJSONSlice, "List of PVC json structs")
	...
	cmd.Flags().StringVar(&ctl.Type, "spec-type", ctl.Type, "Type of Blackduck")
	cmd.Flags().StringVar(&ctl.DesiredState, "spec-desired-state", ctl.DesiredState, "Desired state of Blackduck")
	cmd.Flags().StringSliceVar(&ctl.Environs, "spec-environs", ctl.Environs, "List of Environment Variables (NAME:VALUE)")
	...
	cmd.Flags().StringVar(&ctl.LicenseKey, "spec-license-key", ctl.LicenseKey, "License Key for the Knowledge Base")
}

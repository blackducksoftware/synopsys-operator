...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PVCClaims) DeepCopyInto(out *PVCClaims) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PVCClaims.
func (in *PVCClaims) DeepCopy() *PVCClaims {
	if in == nil {
		return nil
	}
	out := new(PVCClaims)

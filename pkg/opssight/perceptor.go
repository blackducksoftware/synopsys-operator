...
func (p *SpecConfig) PerceptorReplicationController() *components.ReplicationController {
	replicas := int32(1)
...
func (p *SpecConfig) perceptorPod() *components.Pod {
...
func (p *SpecConfig) perceptorContainer() *components.Container {

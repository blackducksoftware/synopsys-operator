...
func (g *GrDeployer) GetReportDeployment() *components.Deployment {
...
func (g *GrDeployer) GetReportPod() *components.Pod {
...
func (g *GrDeployer) getReportVolumes() []*components.Volume {

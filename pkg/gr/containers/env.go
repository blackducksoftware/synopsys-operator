...
func (g *GrDeployer) getCommonEnvConfigs() []*horizonapi.EnvConfig {
...
func (g *GrDeployer) getSwipEnvConfigs() []*horizonapi.EnvConfig {
	var envs []*horizonapi.EnvConfig
...
func (g *GrDeployer) getPostgresEnvConfigs() []*horizonapi.EnvConfig {
	var envs []*horizonapi.EnvConfig
...
func (g *GrDeployer) getMongoEnvConfigs() []*horizonapi.EnvConfig {
	var envs []*horizonapi.EnvConfig
...
func (g *GrDeployer) getEventStoreLegacyEnvConfigs() []*horizonapi.EnvConfig {
	var envs []*horizonapi.EnvConfig
...
func (g *GrDeployer) getEventStoreEnvConfigs(role string) []*horizonapi.EnvConfig {
	var envs []*horizonapi.EnvConfig
	envs = append(envs, &horizonapi.EnvConfig{Type: horizonapi.EnvVal, NameOrPrefix: "EVENT_STORE_ADDR", KeyOrVal: "eventstore"})

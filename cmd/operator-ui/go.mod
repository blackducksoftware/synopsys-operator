...
replace (
	...
	github.com/blackducksoftware/synopsys-operator => github.com/blackducksoftware/synopsys-operator v0.0.0-20190717185730-eb64b8d9d032
...
require (
	...
	github.com/blackducksoftware/synopsys-operator v0.0.0-20190717185730-eb64b8d9d032

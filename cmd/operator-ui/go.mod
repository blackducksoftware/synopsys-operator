...
require (
	...
	github.com/blackducksoftware/synopsys-operator v0.0.0-20200220133049-4be7820f29b8
...
replace (
	...
	github.com/blackducksoftware/synopsys-operator => github.com/blackducksoftware/synopsys-operator v0.0.0-20200220133049-4be7820f29b8

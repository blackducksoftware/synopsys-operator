...
require (
	...
	github.com/blackducksoftware/synopsys-operator v0.0.0-20191101143255-eaf96aa3f7b6
...
replace (
	...
	github.com/blackducksoftware/synopsys-operator => github.com/blackducksoftware/synopsys-operator v0.0.0-20191101143255-eaf96aa3f7b6
